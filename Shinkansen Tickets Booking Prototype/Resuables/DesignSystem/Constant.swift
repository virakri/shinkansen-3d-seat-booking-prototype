...
struct Constant {
    ...
    static let buttonEdgeInset: UIEdgeInsets = UIEdgeInsets(top: (multiplier * 18).pixelRounded(),
    ...
    static let buttonTextEdgeInset: UIEdgeInsets = UIEdgeInsets(top: (multiplier * 14).pixelRounded(),
