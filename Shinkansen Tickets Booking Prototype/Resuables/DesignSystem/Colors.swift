...
extension UIColor {
    ...
    //
    static let lightModeComponent: Component =
        Component(background: UIColor.basic.offWhite,
    ...
    static let darkModeComponent: Component =
        Component(background: UIColor.basic.offBlack,
